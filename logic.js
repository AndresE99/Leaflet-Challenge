...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (data) {
  ...
  // color and scale each earthquake and put them into styleInfo
  ...
  L.geoJson(data, {
    ...
    style: styleInfo,
    // Create popups for each marker and add to map
  ...
  legend.onAdd = function () {
    ...
    for (let i = 0; i < grades.length; i++) {
      div.innerHTML += "<i class='legend-color' style='background:" + colors[i] + "'></i> "
